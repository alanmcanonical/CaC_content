...
# ----------------------------------------------------------------------------------
# The template depends on ensure_file_paths_and_file_regexes_are_correctly_defined()
# function from ssh/utils.py, which does not exist in focal branch.
# Functions below are backported directly from master(bfe49534f8):ssg/utils.py
